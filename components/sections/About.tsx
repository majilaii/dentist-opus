  ...
  return (
    <section ref={ref} id="about" className="relative bg-ivory py-12 md:py-16 overflow-hidden">
      <div className="container-x">
        ...
        <div className="mt-6 md:mt-10 grid grid-cols-12 gap-6 md:gap-10 lg:gap-14 items-stretch">
          {/* Text column */}
          <div className="col-span-12 md:col-span-7 flex flex-col">
            ...
            <Reveal delay={0.3} className="mt-auto pt-8 md:pt-10 max-w-xl">
          ...
          <motion.div
            style={{ y: yImg }}
            className="col-span-12 md:col-span-5 relative aspect-[4/5] md:aspect-auto md:h-full md:min-h-[520px] overflow-hidden rounded-[2px] bg-stone-200"
          >
            <Image
